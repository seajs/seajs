define(function(require) {
  ...
  assert(util.dirname('http://cdn.com/js/file.js?t=xxxxx') === 'http://cdn.com/js/', 'dirname')
  ...
  assert(util.id2Uri('') === '', 'id2Uri')
  assert(util.id2Uri('http://t.com/x.js') === 'http://t.com/x.js', 'id2Uri')
  assert(util.id2Uri('./z.js', 'http://t.com/x.js') === 'http://t.com/z.js', 'id2Uri')
  ...
  //assert(util.parseAlias('jquery') === 'jquery/1.8.0/jquery', 'parseAlias')
  ...
  //assert(util.parseAlias('#jquery') === 'jquery', 'parseAlias')
  ...
  assert(require.resolve(t) === t, 'require.resolve')

  // issues#430
  assert(require.resolve('./front_net/jquery.plupload.queue.js#').indexOf('jquery.plupload.queue.js') > 0, 'require.resolve')
