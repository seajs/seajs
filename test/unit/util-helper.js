define(function(require) {
  ...
  test.assert(util.normalize('c?t=20110525') === 'c.js', 'normalize');
  test.assert(util.normalize('c?t=20110525.js') === 'c.js', 'normalize');
  ...
  test.assert(util.parseAlias('http://test.com/router') === 'http://test.com/router?t=20110525', 'parseAlias');
