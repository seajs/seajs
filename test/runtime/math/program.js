seajs.config({ base: location.href.replace(/(.*\/)([^\/]+)/, '$1') + 'runtime/math' });
define("program",["../../test","increment"],function(a){var b=a("../../test"),c=a("./increment").increment;b.assert(c(1)===2,"The result of inc(1) is 2."),b.done()});
